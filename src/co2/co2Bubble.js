  ...
  function bubbleChart() {
    ...
    function chart(selection) {
      ...
      if (!twoYears) {
        ...
        if (sumAfrica < 0) {
          rectangleNA.style("fill", d3.interpolateGreens(Math.abs(sumAfrica/interpolateScalar)));
        } else {
          rectangleNA.style("fill", d3.interpolateReds(sumAfrica/interpolateScalar));
        }

        if (sumNA < 0) {
          rectangleAfrica.style("fill", d3.interpolateGreens(Math.abs(sumNA/interpolateScalar)));
        } else {
          rectangleAfrica.style("fill", d3.interpolateReds(sumNA/interpolateScalar));
        }

        if (sumSA < 0) {
          rectangleAsia.style("fill", d3.interpolateGreens(Math.abs(sumSA/interpolateScalar)));
        } else {
          rectangleAsia.style("fill", d3.interpolateReds(sumSA/interpolateScalar));
        }

        if (sumEU < 0) {
          rectangleEurope.style("fill", d3.interpolateGreens(Math.abs(sumEU/interpolateScalar)));
        } else {
          rectangleEurope.style("fill", d3.interpolateReds(sumEU/interpolateScalar));
        }
        ...
        if (sumAsia < 0) {
          rectangleSA.style("fill", d3.interpolateGreens(Math.abs(sumAsia/interpolateScalar)));
        } else {
          rectangleSA.style("fill", d3.interpolateReds(sumAsia/interpolateScalar));
        }
      ...
      topEmissions.append("text").html(Math.round(parseFloat(sumAsia) * 1000) / 1000 + " MtCO2").attr("x", 810).attr("y", 570).attr("font-weight", "bold").attr("class", "lightText").attr("id", "sumAsia");
      topEmissions.append("text").html(Math.round(parseFloat(sumNA) * 1000) / 1000 + " MtCO2").attr("x", 80).attr("y", 570).attr("font-weight", "bold").attr("class", "lightText").attr("id", "sumNA");
      topEmissions.append("text").html(Math.round(parseFloat(sumSA) * 1000) / 1000 + " MtCO2").attr("x", 220).attr("y", 570).attr("font-weight", "bold").attr("class", "lightText").attr("id", "sumSA");
      topEmissions.append("text").html(Math.round(parseFloat(sumEU) * 1000) / 1000 + " MtCO2").attr("x", 420).attr("y", 570).attr("font-weight", "bold").attr("class", "lightText").attr("id", "sumEU");
      topEmissions.append("text").html(Math.round(parseFloat(sumAfrica) * 1000) / 1000 + " MtCO2").attr("x", 1050).attr("y", 570).attr("font-weight", "bold").attr("id", "sumAfrica");

      topEmissions.append("text").html("Oceania").attr("x", 620).attr("y", 510).attr("class", "lightText").attr("id", "titleOceania");
      topEmissions.append("text").html("Asia").attr("x", 810).attr("y", 510).attr("class", "lightText").attr("id", "titleAsia");
      topEmissions.append("text").html("North America").attr("x", 80).attr("y", 510).attr("class", "lightText").attr("id", "titleNA");
      topEmissions.append("text").html("South America").attr("x", 220).attr("y", 510).attr("class", "lightText").attr("id", "titleSA");
      topEmissions.append("text").html("Europe").attr("x", 420).attr("y", 510).attr("class", "lightText").attr("id", "titleEU");
      topEmissions.append("text").html("Africa").attr("x", 1050).attr("y", 510).attr("id", "titleAfrica");

      if (!twoYears) {
        topEmissions.append("text").html("Total Emissions:").attr("x", 620).attr("y", 540).attr("class", "lightText");
        topEmissions.append("text").html("Total Emissions:").attr("x", 810).attr("y", 540).attr("class", "lightText");
        topEmissions.append("text").html("Total Emissions:").attr("x", 80).attr("y", 540).attr("class", "lightText");
        topEmissions.append("text").html("Total Emissions:").attr("x", 220).attr("y", 540).attr("class", "lightText");
        topEmissions.append("text").html("Total Emissions:").attr("x", 420).attr("y", 540).attr("class", "lightText");
        topEmissions.append("text").html("Total Emissions:").attr("x", 1050).attr("y", 540);
      } else {
        topEmissions.append("text").html("Net Difference:").attr("x", 620).attr("y", 540).attr("id", "netOceania");
        topEmissions.append("text").html("Net Difference:").attr("x", 810).attr("y", 540).attr("id", "netAsia");
        topEmissions.append("text").html("Net Difference:").attr("x", 80).attr("y", 540).attr("id", "netNA");
        topEmissions.append("text").html("Net Difference:").attr("x", 220).attr("y", 540).attr("id", "netSA");
        topEmissions.append("text").html("Net Difference:").attr("x", 420).attr("y", 540).attr("id", "netEU");
        topEmissions.append("text").html("Net Difference:").attr("x", 1050).attr("y", 540).attr("id", "netAfrica");
      }

      d3.selectAll("text").style('fill', '#3B444C').style('font-family', 'Oswald');
      if (twoYears) {
        if (sumNA > 800 || sumNA < -800) {
          d3.select("#titleNA").style("fill", "#d3d3d3");
          d3.select("#sumNA").style("fill", "#d3d3d3");
          d3.select("#netNA").style("fill", "#d3d3d3");
        }
        if (sumEU > 800 || sumEU < -800) {
          d3.select("#titleEU").style("fill", "#d3d3d3");
          d3.select("#sumEU").style("fill", "#d3d3d3");
          d3.select("#netEU").style("fill", "#d3d3d3");
        }
        if (sumSA > 800 || sumSA < -800) {
          d3.select("#titleSA").style("fill", "#d3d3d3");
          d3.select("#sumSA").style("fill", "#d3d3d3");
          d3.select("#netSA").style("fill", "#d3d3d3");
        }
        if (sumOceania > 800 || sumOceania < -800) {
          d3.select("#titleOceania").style("fill", "#d3d3d3");
          d3.select("#sumOceania").style("fill", "#d3d3d3");
          d3.select("#netOceania").style("fill", "#d3d3d3");
        }
        if (sumAsia > 800 || sumAsia < -800) {
          d3.select("#titleAsia").style("fill", "#d3d3d3");
          d3.select("#sumAsia").style("fill", "#d3d3d3");
          d3.select("#netAsia").style("fill", "#d3d3d3");
        }
        if (sumAfrica > 800 || sumAfrica < -800) {
          d3.select("#titleAfrica").style("fill", "#d3d3d3");
          d3.select("#sumAfrica").style("fill", "#d3d3d3");
          d3.select("#netAfrica").style("fill", "#d3d3d3");
        }
      } else {
        d3.selectAll(".lightText").style('fill', '#d3d3d3').style('font-family', 'Oswald');
      }
    }
